...
class test_mailbox_01(cohdl.Entity):
    clk = Port.input(Bit)
...
@cocotb_util.test()
async def testbench_mailbox_01(dut: test_mailbox_01):
...
class Unittest(unittest.TestCase):
    def test_mailbox_01(self):
        cocotb_util.run_cocotb_tests(test_mailbox_01, __file__, self.__module__)
