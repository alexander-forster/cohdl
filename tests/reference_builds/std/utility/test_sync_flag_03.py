...
def gen_entity():
    class test_sync_flag_03(cohdl.Entity):
        clk = Port.input(Bit)
...
@cocotb_util.test()
async def testbench_sync_flag_03_mock(dut: test_sync_flag_03):
    dut.reset.value = 0
    dut.clk.value = 0
...
class Unittest(unittest.TestCase):
    ...
    def test_sync_flag_03_0_0(self):
        self._test_with_args(0, 0)

    def test_sync_flag_03_0_1(self):
        self._test_with_args(0, 1)

    def test_sync_flag_03_1_0(self):
        self._test_with_args(1, 0)

    def test_sync_flag_03_0_2(self):
        self._test_with_args(0, 2)

    def test_sync_flag_03_2_0(self):
        self._test_with_args(2, 0)

    def test_sync_flag_03_1_3(self):
        self._test_with_args(0, 3)

    def test_sync_flag_03_4_2(self):
