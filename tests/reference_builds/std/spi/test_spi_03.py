...
@cocotb_util.test()
async def testbench_spi_03(dut: test_spi_03):
...
class Unittest(unittest.TestCase):
    def test_spi_03(self):
        cocotb_util.run_cocotb_tests(test_spi_03, __file__, self.__module__)
