...
@cocotb_util.test()
async def testbench_spi_00(dut: test_spi_00):
...
class Unittest(unittest.TestCase):
    def test_spi_00(self):
        cocotb_util.run_cocotb_tests(test_spi_00, __file__, self.__module__)
