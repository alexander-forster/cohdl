...
@cocotb_util.test()
async def testbench_spi_02(dut: test_spi_02):
...
class Unittest(unittest.TestCase):
    def test_spi_02(self):
        cocotb_util.run_cocotb_tests(test_spi_02, __file__, self.__module__)
