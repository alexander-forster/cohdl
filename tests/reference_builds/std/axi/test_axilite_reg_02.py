...
class test_axilite_reg_02(cohdl.Entity):
    clk = Port.input(Bit)
...
@cocotb.test()
async def testbench_axilite_reg_02(dut: test_axilite_reg_02):
...
class Unittest(unittest.TestCase):
    def test_axilite_reg_02(self):
        cohdl_testutil.run_cocotb_tests(test_axilite_reg_02, __file__, self.__module__)
