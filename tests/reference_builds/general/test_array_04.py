...
class test_array_04(cohdl.Entity):
    ...
    def architecture(self):
        default = Array[BitVector[4], 4](["0000", "0000", "1111", "1111"])
        option_a = Array[BitVector[4], 4](["1100", "0011", "1001", "0110"])
        option_b = Array[BitVector[4], 4](["1111", "1111", "0000", "0000"])

        mem = Signal[Array[BitVector[4], 4]](default)
...
@cocotb_util.test()
async def testbench_functions(dut: test_array_04):
    ...
    default = ["0000", "0000", "1111", "1111"]
    option_a = ["1100", "0011", "1001", "0110"]
    option_b = ["1111", "1111", "0000", "0000"]

    for addr in addr_gen.random(256):
...
class Unittest(unittest.TestCase):
    def test_base(self):
        cocotb_util.run_cocotb_tests(test_array_04, __file__, self.__module__)
