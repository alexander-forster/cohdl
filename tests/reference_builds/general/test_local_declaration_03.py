...
class test_local_declaration_03(cohdl.Entity):
    inp1 = Port.input(Bit)
...
@cocotb_util.test()
async def testbench_local_declaration_01(dut: test_local_declaration_03):
...
class Unittest(unittest.TestCase):
    def test_local_declaration_03(self):
        cocotb_util.run_cocotb_tests(
            test_local_declaration_03, __file__, self.__module__
        )
