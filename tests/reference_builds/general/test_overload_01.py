...
class TestComplex:
    ...
    def __add__(self, other):
        return TestComplex(self.real + other.real, self.imag + other.imag)

    def __sub__(self, other):
        return TestComplex(self.real - other.real, self.imag - other.imag)


class test_overload_01(cohdl.Entity):
...
@cocotb_util.test()
async def testbench_overload_01(dut: test_overload_01):
...
class Unittest(unittest.TestCase):
    def test_overload_01(self):
        cocotb_util.run_cocotb_tests(test_overload_01, __file__, self.__module__)
