...
class test_local_declaration_02(cohdl.Entity):
    inp1 = Port.input(Bit)
...
@cocotb_util.test()
async def testbench_local_declaration_01(dut: test_local_declaration_02):
...
class Unittest(unittest.TestCase):
    def test_local_declaration_02(self):
        cocotb_util.run_cocotb_tests(
            test_local_declaration_02, __file__, self.__module__
        )
