...
class Unsigned(BitVector):
    ...
    def __rmul__(self, lhs: Unsigned | int | Integer) -> Unsigned: ...
    def __floordiv__(self, rhs: Unsigned) -> Unsigned: ...
    def __rfloordiv__(self, rhs: Unsigned) -> Unsigned: ...
    def _cohdl_truncdiv_(self, rhs: Unsigned | int | Integer) -> Unsigned: ...
    def _cohdl_rtruncdiv_(self, lhs: Unsigned | int | Integer) -> Unsigned: ...
    def __mod__(self, rhs: Unsigned | int | Integer) -> Unsigned: ...
    def __rmod__(self, lhs: Unsigned | int | Integer) -> Unsigned: ...
    def _cohdl_rem_(self, rhs: Unsigned | int | Integer) -> Unsigned: ...
    def _cohdl_rrem_(self, lhs: Unsigned | int | Integer) -> Unsigned: ...
